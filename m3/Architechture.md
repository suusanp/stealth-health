...
Our application aims to be more similar to FitoTrack than Gadgetbridge, but will allow the user to add data from their wearable devices, rather than relying "starting" and "stopping" the workout through the application itself. It also aims to support more features to track the user's sleep cycles, weight etc. In summary, our application aims to be on-par and even more privacy focused than these similar applications discussed, and offer most of important features a wearable device offers. 
