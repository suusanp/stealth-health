...
Overall, there is an increased threat to users’ privacy due to the increased data collection from Fitbit and its parent company Google. Users’ data can be shared with third-parties who have their own privacy policy, used in targeted advertisement, or leaked online. There was a data leak in [2021](https://healthitsecurity.com/news/61m-fitbit-apple-users-had-data-exposed-in-wearable-device-data-breach) exposing 61 million fitness tracker data records (Fitbit included) and in [2020](https://hackernoon.com/2-million-fitbit-accounts-was-exposed-by-cybercriminals-aa7u36pj), 2 million Fitbit users’ usernames and passwords were leaked online by hackers. 
...
Furthermore, usage of vague language and contradiction in Fitbit's privacy policy makes it difficult for users to make informed choices. For example, the policy states: "We never sell the personal information of our users. We do work with partners who provide us with advertising services"[^11]. This is a contradiction that seemingly attempts to take advantage of the fact that many users may not understand the difference between selling personal information and sharing it with third parties for advertising purposes.
...
- **Compliance with Privacy Regulations**: Thorough analysis of Fitbit's privacy practices in relation to PIPEDA reveals significant non-compliance with its principles. Fitbit's privacy policies are vague, contradictory, and do not clearly define the purposes for which personal information is collected, used, and disclosed to third parties. This obfuscation is likely intentional; Fitbit does not want its users to understand the full extent of its data collection and sharing practices, as Google relies on the collection of personal information for its advertising and marketing services. More alarmingly, this analysis reveals the limitations of PIPEDA in protecting user privacy. PIPEDA's lack of enforcement, along with its usage of vague language and lack of proper definitions, allow companies like Fitbit to exploit the ambiguities while maintaining the semblance of legal compliance. This is a significant concern, as it suggests that PIPEDA is not equipped to protect users' privacy rights in the face of modern data collection practices.
...
- Investigate the ways regulations can be improved and speficied, to protect user privacy in the face of modern health data collection practices.
